...
import SMTPTransport from "nodemailer/lib/smtp-transport"; // ✅ TS tipi
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const transportOptions: SMTPTransport.Options = {
      ...
      pool: false,                                    // serverless için tek atımlık
      connectionTimeout: 10_000,
      greetingTimeout: 6_000,
      socketTimeout: 12_000,
      requireTLS: (SMTP_SECURE || "false") !== "true",// 587'de STARTTLS'i zorla
      tls: {
